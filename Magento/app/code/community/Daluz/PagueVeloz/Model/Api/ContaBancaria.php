...
class Daluz_PagueVeloz_Model_Api_ContaBancaria extends Daluz_PagueVeloz_Model_Api_PagueVeloz
{
	...
	public function GetById(Daluz_PagueVeloz_Model_Dto_ContaBancariaDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
		$contexto->setMethod('get');
		$contexto->addHeader($this->_default_header);
	...
	public function Post(Daluz_PagueVeloz_Model_Dto_ContaBancariaDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
	...
	public function Put(Daluz_PagueVeloz_Model_Dto_ContaBancariaDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
	...
	public function Delete(Daluz_PagueVeloz_Model_Dto_ContaBancariaDTO $dto)
	{
