...
class Daluz_PagueVeloz_Model_BoletoMethod extends Mage_Payment_Model_Method_Banktransfer {
    ...
    public function generateBoletoUrl($valor, $seuNumero, $nome, $cpf) {
		$boleto = new Daluz_PagueVeloz_Model_Api_Boleto(Mage::getModel('pagueveloz/dto_emailDTO', $this->getEmail()), $this->getToken());
