...
class Daluz_PagueVeloz_Model_Dto_EmailDTO
{
	private $_email;
	...
	{
		if (empty($email))
			throw new Daluz_PagueVeloz_Model_Exceptions_ArgumentNullException("$email é null");
		else if (!self::isValidEmail($email))
			throw new Daluz_PagueVeloz_Model_Exceptions_InvalidEmailException("$email é inválido");
