...
class Daluz_PagueVeloz_Model_Services_Curl implements Daluz_PagueVeloz_Model_Interfaces_IHttpClient
{
	private $_curl;
	...
	function __construct()
	{
		...
		if(empty($this->_curl))
			throw new Daluz_PagueVeloz_Model_Exceptions_ArgumentNullException("curl_init is null");
	}

	function Send(Daluz_PagueVeloz_Model_Common_HttpContext $context)
	{
		if (empty($context))
			throw new Daluz_PagueVeloz_Model_Exceptions_ArgumentNullException("$context is null");
        ...
        $response = new Daluz_PagueVeloz_Model_Common_HttpResponse();
