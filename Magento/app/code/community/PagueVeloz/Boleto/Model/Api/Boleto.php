...
class PagueVeloz_Boleto_Model_Api_Boleto extends PagueVeloz_Boleto_Model_Api_PagueVeloz 
{
	...
	public function Get(PagueVeloz_Boleto_Model_Dto_BoletoDTO $dto)
	{
	...
	public function Post(PagueVeloz_Boleto_Model_Dto_BoletoDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
