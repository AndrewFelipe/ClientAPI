...
class PagueVeloz_Boleto_Model_Api_Saque extends PagueVeloz_Boleto_Model_Api_PagueVeloz
{
	...
	public function Post(PagueVeloz_Boleto_Model_Dto_SaqueDTO $dto)
	{
	...
	public function GetById(PagueVeloz_Boleto_Model_Dto_SaqueDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
		$contexto->setMethod('get');
		$contexto->addHeader($this->_default_header);
	...
	public function Delete(PagueVeloz_Boleto_Model_Dto_SaqueDTO $dto)
	{
		$contexto = Mage::getModel('pagueveloz/common_httpContext');
