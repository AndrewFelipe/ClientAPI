...
class PagueVeloz_Boleto_Model_Api_Transferencia extends PagueVeloz_Boleto_Model_Api_PagueVeloz
{
	...
	public function __construct(PagueVeloz_Boleto_Model_Dto_EmailDTO $email, $token)
	{
		...
		parent::__construct('/v1/Transferencia', $this->getAuthDto(), $machine);
	}

	public function Post(PagueVeloz_Boleto_Model_Dto_TransferenciaDTO $dto)
	{
