...
class PagueVeloz_Boleto_Model_Dto_EmailDTO
{
	private $_email;
	...
	{
		if (empty($email))
			throw new PagueVeloz_Boleto_Model_Exceptions_ArgumentNullException("$email é null");
		else if (!self::isValidEmail($email))
			throw new PagueVeloz_Boleto_Model_Exceptions_InvalidEmailException("$email é inválido");
