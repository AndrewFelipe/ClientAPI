...
class EmitirBoletoDTO
{
	...
	{
		if (empty($vencimento))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$vencimento\" é null.");
	...
	{
		if (empty($valor))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$valor\" é null.");
		$valor *= 100;
		$this->_valor = $valor;
	}
	...
	{
		if (empty($seuNumero))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$seuNumero\" é null.");
	...
	{
		if (empty($sacado))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$sacado\" é null.");
	...
	public function setCpfCnpjSacado($cpfCnpjSacado)
	{
		if (empty($cpfCnpjSacado))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$cpfCnpjSacado\" é null.");
	...
	{
		if (empty($linha1))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$linha1\" é null.");
	...
	{
		if (empty($linha2))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$linha2\" é null.");
	...
	public function setCpfCnpjCedente($cpfCnpjCedente)
	{
		if (empty($cpfCnpjCedente))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$cpfCnpjCedente\" é null.");
	...
	{
		if (empty($cedente))
			throw new ArgumentNullException("Argumento informado não deve ser NULL. \"$cedente\" é null.");
